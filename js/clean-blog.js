/*!
 * Clean logs v1.0.0 (http://startbootstrap.com)
        ...
        $(window).on('scroll', {
            ...
            function() {
                ...
                if (currentTop < this.previousTop) {
                    //if scrolling up...
                    if ($('.navbar-custom').hasClass('scroll-down-hide')) {
                        $('.navbar-custom').removeClass('scroll-down-hide');
                    }
                    if (currentTop > 50){
                    } else {
                    ...
                    if ($(".navbar").offset().top > 50) {
                        ...
                        $('.navbar-custom').addClass("scroll-down-hide");
                    }
                }
